...
class RendamanController extends Controller
{
    private $apiService;
    private $buildRes;
    ...
    {
        // if (!auth()->user()->can('rendaman.view')) {
        ...
        try {
            if (request()->ajax()) {
                ...
                $render =  view('Task.rendaman.table', compact('call_employees', 'order'))->render();
                return $this->buildRes->RESPONSE_REQ('success', $render, null);
            }

            return  view('Task.rendaman.index');
        } catch (\Exception $e) {
    ...
    public function create(Request $request)
    {
        ...
        try {
            ...
            $render = view('Task.rendaman.create', compact('operationals'))->render();
            return $this->buildRes->RESPONSE_REQ('success', $render, null);
        } catch (\Exception $e) {
            Log::emergency("File:" . $e->getFile() . "Line:" . $e->getLine() . "Message:" . $e->getMessage());
    ...
    {
        // if (!auth()->user()->can('rendaman.create')  || !$request->ajax()) {
        //     abort(403, 'Unauthorized action.');
        // }
