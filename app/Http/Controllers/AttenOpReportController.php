        ...
        try {
            ...
            if (request()->ajax()) {
                ...
                if ($request->has('start_date') && $request->has('end_date')) {
                    ...
                    $render =  view('Report.attendance_operational.table', compact('datas', 'start_date_work_day', 'end_date_work_day', 'start_date_overtime', 'end_date_overtime'))->render();
                    return $this->buildRes->RESPONSE_REQ('success', $render, null);
                } else {
                    $render =  view('Report.attendance_operational.table', compact('datas'))->render();
                    return $this->buildRes->RESPONSE_REQ('success', $render, null);
                }
            ...
            return  view('Report.attendance_operational.index', compact('department_bios'));
        } catch (\Exception $e) {
