...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        Blade::if('activemenu', function ($menu) {
            ...
            $sub_menu_tasks = ['operational', 'TSO', 'request-task'];
            $sub_menu_reports = ['attendance-report', 'attendance-card', 'food-archive', 'transaction-report', 'salary-archive'];
        ...
        Blade::directive('convertnorp', function ($money) {
