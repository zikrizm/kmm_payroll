...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('salary_archives', function (Blueprint $table) {
            ...
            $table->decimal('total_HK_value', 22)->nullable();
            $table->decimal('total_JL_value', 22)->nullable();
            $table->decimal('total_kasbon_pay_value', 22)->nullable();
            $table->decimal('total_salary_pay_value', 22)->nullable();
            $table->decimal('total_overtime_pay_value', 22)->nullable();
            $table->decimal('total_tbhn_u_position_pay_value', 22)->nullable();
            $table->decimal('total_tbhn_u_libur_pay_value', 22)->nullable();
