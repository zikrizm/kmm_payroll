<main class="flex flex-col gap-8  pt-4 w-[375px] xs/max:w-[280px]">
    ...
    <form autocomplete="off" action="{{ route('access-controls.store') }}" method="POST" class="submit-role">
        @csrf
        <!-- {{ csrf_field() }} -->
        <main class="px-4 flex flex-col gap-4 xs/max:gap-3 mb-8">
            ...
            <div class="flex flex-col gap-4">
                ...
                <div class="flex flex-col flex-1 gap-1">
                    ...
                    <label
                        ...
                        <input type="checkbox" class="accent-violet-500 user-check" name="roles[]" value="user.view">
                        View user
                    </label>
                    <label
                        class="text-sm xs/max:text-xs text-gray-500 flex items-center gap-2 bg-gray-50 rounded-md px-2 py-1 cursor-pointer hover:bg-gray-100">
                        <input type="checkbox" class="accent-violet-500 user-check" name="roles[]" value="user.create">
                        Add user
                    </label>
                    <label
                        class="text-sm xs/max:text-xs text-gray-500 flex items-center gap-2 bg-gray-50 rounded-md px-2 py-1 cursor-pointer hover:bg-gray-100">
                        <input type="checkbox" class="accent-violet-500 user-check" name="roles[]" value="user.update">
                        Edit user
                    </label>
                    <label
                        class="text-sm xs/max:text-xs text-gray-500 flex items-center gap-2 bg-gray-50 rounded-md px-2 py-1 cursor-pointer hover:bg-gray-100">
                        <input type="checkbox" class="accent-violet-500 user-check" name="roles[]" value="user.delete">
                        Delete user
                    </label>
                </div>
            </div>
            ...
            <div class="flex flex-col gap-4">
                ...
                <div class="flex flex-col flex-1 gap-1">
                    ...
                    <label
                        class="text-sm xs/max:text-xs text-gray-500 flex items-center gap-2 bg-gray-50 rounded-md px-2 py-1 cursor-pointer hover:bg-gray-100">
                        <input type="checkbox" class="accent-violet-500 access-control-check" name="roles[]"
                    ...
                    <label
                        class="text-sm xs/max:text-xs text-gray-500 flex items-center gap-2 bg-gray-50 rounded-md px-2 py-1 cursor-pointer hover:bg-gray-100">
                        <input type="checkbox" class="accent-violet-500 access-control-check"
                            value='access-control.delete' name="roles[]"> Delete access-control
                    </label>
                </div>
            </div>
            <hr>
            <div class="flex flex-col gap-4">
                ...
                <div class="flex flex-col flex-1 gap-1">
                    ...
                    <label
                        class="text-sm xs/max:text-xs text-gray-500 flex items-center gap-2 bg-gray-50 rounded-md px-2 py-1 cursor-pointer hover:bg-gray-100">
                        <input type="checkbox" class="accent-violet-500 shift-check" name="roles[]" value="shift.view">
                        View shift
                    </label>
                    <label
                        class="text-sm xs/max:text-xs text-gray-500 flex items-center gap-2 bg-gray-50 rounded-md px-2 py-1 cursor-pointer hover:bg-gray-100">
                        <input type="checkbox" class="accent-violet-500 shift-check" name="roles[]"
                            value="shift.create">
                        Add shift
                    </label>
                    <label
                    ...
                    <label
                        class="text-sm xs/max:text-xs text-gray-500 flex items-center gap-2 bg-gray-50 rounded-md px-2 py-1 cursor-pointer hover:bg-gray-100">
                        <input type="checkbox" class="accent-violet-500 shift-check" value='shift.delete'
                            name="roles[]"> Delete shift
                    </label>
                </div>
            </div>
            <hr>
            <div class="flex flex-col gap-4">
                ...
                <div class="flex flex-col flex-1 gap-1">
                    ...
                    <label
                        class="text-sm xs/max:text-xs text-gray-500 flex items-center gap-2 bg-gray-50 rounded-md px-2 py-1 cursor-pointer hover:bg-gray-100">
                        <input type="checkbox" class="accent-violet-500 group-check" name="roles[]" value="group.view">
                        View group
                    </label>
                    <label
                        class="text-sm xs/max:text-xs text-gray-500 flex items-center gap-2 bg-gray-50 rounded-md px-2 py-1 cursor-pointer hover:bg-gray-100">
                        <input type="checkbox" class="accent-violet-500 group-check" name="roles[]"
                            value="group.create">
                        Add group
                    </label>
                    <label
                    ...
                    <label
                        class="text-sm xs/max:text-xs text-gray-500 flex items-center gap-2 bg-gray-50 rounded-md px-2 py-1 cursor-pointer hover:bg-gray-100">
                        <input type="checkbox" class="accent-violet-500 group-check" value='group.delete'
                            name="roles[]"> Delete group
                    </label>
                </div>
            </div>
            <hr>
            <div class="flex flex-col gap-4">
                ...
                <div class="flex flex-col flex-1 gap-1">
                    ...
                    <label
                        class="text-sm xs/max:text-xs text-gray-500 flex items-center gap-2 bg-gray-50 rounded-md px-2 py-1 cursor-pointer hover:bg-gray-100">
                        <input type="checkbox" class="accent-violet-500 work-section-check" name="roles[]"
                            value="work-section.view">
                        View work-section
                    </label>
                    <label
                        class="text-sm xs/max:text-xs text-gray-500 flex items-center gap-2 bg-gray-50 rounded-md px-2 py-1 cursor-pointer hover:bg-gray-100">
                        <input type="checkbox" class="accent-violet-500 work-section-check" name="roles[]"
                            value="work-section.create">
                        Add work-section
                    </label>
                    <label
                        class="text-sm xs/max:text-xs text-gray-500 flex items-center gap-2 bg-gray-50 rounded-md px-2 py-1 cursor-pointer hover:bg-gray-100">
                        <input type="checkbox" class="accent-violet-500 work-section-check" name="roles[]"
                            value="work-section.update">
                        Edit work-section
                    </label>
                    <label
                        class="text-sm xs/max:text-xs text-gray-500 flex items-center gap-2 bg-gray-50 rounded-md px-2 py-1 cursor-pointer hover:bg-gray-100">
                        <input type="checkbox" class="accent-violet-500 work-section-check" value='work-section.delete'
                            name="roles[]"> Delete work-section
                    </label>
                </div>
            </div>
            <hr>
            <div class="flex flex-col gap-4">
                ...
                <div class="flex flex-col flex-1 gap-1">
                    ...
                    <label
                        class="text-sm xs/max:text-xs text-gray-500 flex items-center gap-2 bg-gray-50 rounded-md px-2 py-1 cursor-pointer hover:bg-gray-100">
                        <input type="checkbox" class="accent-violet-500 holiday-check" name="roles[]"
                            value="holiday.view">
                        View holiday
                    </label>
                    <label
                    ...
                    <label
                        class="text-sm xs/max:text-xs text-gray-500 flex items-center gap-2 bg-gray-50 rounded-md px-2 py-1 cursor-pointer hover:bg-gray-100">
                        <input type="checkbox" class="accent-violet-500 holiday-check" value='holiday.delete'
                            name="roles[]"> Delete holiday
                    </label>
                </div>
            </div>
            <hr>
            <div class="flex flex-col gap-4">
                ...
                <div class="flex flex-col flex-1 gap-1">
                    ...
                    <label
                        class="text-sm xs/max:text-xs text-gray-500 flex items-center gap-2 bg-gray-50 rounded-md px-2 py-1 cursor-pointer hover:bg-gray-100">
                        <input type="checkbox" class="accent-violet-500 employee-check" name="roles[]"
                            value="employee.view">
                        View employee
                    </label>
                    <label
                    ...
                    <label
                        class="text-sm xs/max:text-xs text-gray-500 flex items-center gap-2 bg-gray-50 rounded-md px-2 py-1 cursor-pointer hover:bg-gray-100">
                        <input type="checkbox" class="accent-violet-500 employee-check" value='employee.delete'
