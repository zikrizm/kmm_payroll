<form autocomplete="off" action="{{ route('kasbon.update', ['kasbon' => $kasbon->id]) }}" method="POST"
    ...
    <!-- {{ csrf_field() }} -->
    <section
        class="flex flex-col gap-8 pt-4 bg-white w-[375px] max-h-[90vh] overflow-y-auto overflow-x-hidden relative rounded-lg">
        <header class="px-4 flex flex-col gap-5 pt-4 xs/max:gap-3 relative">
            ...
            <div class="flex flex-col gap-1">
                <div class="flex items-start gap-2">
                    ...
                    <div>
                        <p class="text-2xl font-bold text-gray-900 xs/max:text-xl xs/max:font-semibold">Kasbon
                        </p>
        ...
        <div>
            <main class="px-4 flex flex-col gap-2.5 xs/max:gap-3 mb-8">
                <section class="flex flex-col gap-1">
                    ...
                    <select class="select2-employee" name="employee_id">
                        <option value="1" default disabled selected>Silahkan Pilih</option>
                    </select>
                    <label class="font-normal text-xs text-red-500 xs/max:text-xs employee_id hint-text"></label>
                </section>
                <section class="flex flex-col gap-1">
                ...
                <section class="flex flex-col gap-1">
                    ...
                    {!! FormCustom::input('kasbon', $kasbon->kasbon, [
                        'prefixtext' => 'Rp',
                ...
                <section class="flex flex-col gap-1">
                    ...
                    {!! FormCustom::textarea('notes', $kasbon->notes, ['placeholder' => 'Masukkan catatan kasbon']) !!}
                </section>
            </main>
            <hr>
