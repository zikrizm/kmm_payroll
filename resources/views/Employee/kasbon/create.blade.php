        ...
        <header class="px-4 flex flex-col gap-5 pt-4 xs/max:gap-3 relative">
            ...
            <div class="flex flex-col gap-1">
                <div class="flex items-start gap-2">
                    ...
                    <div>
                        <p class="text-2xl font-bold text-gray-900 xs/max:text-xl xs/max:font-semibold">Tambah kasbon
                        </p>
        ...
        <div>
            <main class="px-4 flex flex-col gap-2.5 xs/max:gap-3 mb-8">
                ...
                <section class="flex flex-col gap-1">
                    ...
                    {!! FormCustom::textarea('notes', null, ['placeholder' => 'Masukkan catatan kasbon']) !!}
                </section>
            </main>
            <hr>
