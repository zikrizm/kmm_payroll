    ...
    <form autocomplete="off" action="{{ route('employees.store') }}" method="POST" class="submit-employee">
        ...
        <main class="px-4 flex flex-col gap-4 xs/max:gap-3 mb-8">
            ...
            <section class="flex flex-col gap-1">
                ...
                <select class="select2" name="work_section" required>
            ...
            <section class="flex flex-col gap-1">
                ...
                <select class="select2" name="group" required>
                    <option value="" selected>Silahkan Pilih</option>
                </select>
                <label class="font-normal text-xs text-red-500 xs/max:text-xs role text-error"></label>
            </section>
             <section class="flex flex-col gap-1">
                ...
                {!! FormCustom::input('daily_salary', null, [ "placeholder" => 'Enter new your daily salary']) !!}
            </section>
            <section class="flex flex-col gap-1">
                <label class="font-normal text-sm text-gray-500 xs/max:text-xs">Pay component*</label>
                {!! FormCustom::input('pay_component', null, [ "placeholder" => 'Enter new your pay component']) !!}
            </section>
        </main>
        <hr>
