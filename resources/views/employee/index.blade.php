...
@section('content')
    ...
    async function onInit(page, q = '') {
        ...
        // * get table ----->
        // *
        var res = await Utils.table('/employees?'+(new URLSearchParams({ page, q}).toString()), null);
    ...
    async function get_modal(idEmployee) {
        // **
        // * open modal form ----->
        // *
        ...
        var toggleStatus = toggle.button('status', (!idEmployee) ? 'active': '', {})
        var toggleGender = toggle.button('gender', null, {})
    ...
    function open_modal_confirm(idEmployee) {
        // **
        // * open modal confirm ----->
        // *
