    ...
    <header class="px-4 flex flex-col gap-5 pt-4 xs/max:gap-3 relative">
        ...
        <div class="flex flex-col gap-1">
            <div class="flex items-start gap-2">
                ...
                <div>
                    <p class="text-2xl font-bold text-gray-900 xs/max:text-xl xs/max:font-semibold">New department</p>
    ...
    <form autocomplete="off" action="{{ route('department.store') }}" method="POST" class="submit-department">
        ...
        <main class="px-4 flex flex-col gap-4 xs/max:gap-3 mb-8">
            <section class="flex flex-col gap-1">
                ...
                {!! FormCustom::input('dept_code', null, [ "placeholder" => 'Enter new your department code']) !!}
            </section>
            <section class="flex flex-col gap-1">
                <label class="font-normal text-sm text-gray-500 xs/max:text-xs">Department name*</label>
                {!! FormCustom::input('dept_name', null, [ "placeholder" => 'Enter new your department name']) !!}
            </section>
            <section class="flex flex-col gap-1">
