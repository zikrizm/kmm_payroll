...
@section('content')
    <div class="flex flex-col gap-6 flex-1 h-full overflow-auto bg-white px-8 pt-8 pb-12">
        <header class="flex justify-between items-start">
            <div class="flex flex-col gap-1">
                <p class="text-3xl font-medium text-gray-900">Laporan Istrahat Tidak Disiplin</p>
                <p class="text-base font-normal text-gray-500">Daftar laporan istirahat tidak disiplin.</p>
            </div>
            <div class="">
        ...
        <div class="flex item-center justify-between gap-3"  style="flex-wrap: wrap;">
            <div class="flex items-start gap-3"  style="flex-wrap: wrap;">
                ...
                <a id="card-working-time" target="_blank"
            ...
            <div class="flex items-center gap-3">
                <x-ui.search-data placeholder="Cari absensi" url="{{ route('break-time-report.index') }}" />
    ...
    async function onInit(data) {
        ...
        // * get table ----->
        // *
        var res = await ApiService.get_table('/break-time-report', dataParams);
