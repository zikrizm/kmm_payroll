    ...
    <table class="border-separate border-spacing-y-2 w-full">
        <thead class="">
            <tr class="text-left">
                ...
                @canany(['work-section.update', 'work-section.delete'])
        ...
        <tbody class="text-sm font-normal text-gray-700">
            ...
            <tr class="cursor-pointer bg-white hover:bg-gray-50">
                ...
                <td class="px-6 py-3 text-left bg-transparent">
                    <p class="text-gray-500 text-sm font-normal truncate xs/max:w-12 flex items-center gap-3">
                        {{ $item->time_start->format('g:i a') }}
                        <x-icon icon="arrow-right" width=12 height=12 viewBox="20 20" class="text-violet-600" />
                        {{ $item->time_end->format('g:i a') }}
                    </p>
                </td>
                <td class="px-6 py-3 text-left bg-transparent">
                    {!! $item->statusBox !!}
