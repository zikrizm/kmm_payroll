...
<div class="h-full flex-1 pb-12 px-8 xs/max:p-4 xs/max:pb-8 overflow-y-auto overflow-x-hidden relative">
    <main class="flex flex-col gap-2 xs/max:gap-4">
        <header class="min-h-[80px] w-full flex justify-between items-center">
            <p class="font-semibold text-2xl text-gray-700 xs/max:text-xl">Shift management</p>
...
<x-modal-confirmation classSubmit="submit-delete-shift"></x-modal-confirmation>
...
<script type="application/javascript">
    ...
    async function onInit() {
        ...
        // * get table ----->
        // *
        var res = await Utils.table('/shifts', null);
        $('.table-content').html(res);
    }

    async function get_modal(idShift) {
        // **
        // * open modal form ----->
        // *
    ...
    function open_modal_confirm(idShift) {
        // **
        // * open modal confirm ----->
        // *
