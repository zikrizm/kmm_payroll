...
@endsection
@section('content')
<div class="pt-8 h-full flex-1 pb-12 px-8 overflow-y-auto overflow-x-hidden relative">
    {{-- <div
    ...
    <main class="flex flex-col gap-8">
        <hgroup class="flex flex-col gap-8">
            <header>
                <p class="text-3xl text-gray-900 font-semibold">Dashboard</p>
...
<div class="fixed z-10 inset-0 invisible min-h-screen hidden duration-300" aria-labelledby="modal-title" role="dialog"
    ...
    <div class="flex items-center justify-center p-4 h-full">
        <div
            class="flex bg-white rounded-lg text-left h-[95vh] overflow-y-auto overflow-x-hidde transform transition-all py-4">
