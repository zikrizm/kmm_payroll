<div class="fixed z-10 inset-0  min-h-screen duration-300 hidden invisible" aria-labelledby="modal-title" role="dialog"
    aria-modal="true" id="confirmation-modal">
        ...
        <div
            ...
            <div class="sm:flex sm:items-start relative ">
                ...
                <div class="flex flex-col gap-8 xs/max:gap-6">
                    <form autocomplete="off" class="{{ $classSubmit }}" method="DELETE">
                        @csrf
                        <!-- {{ csrf_field() }} -->
