@extends('layouts.app')
@section('title', 'Print | Card Attendance Operational')
@section('content')
    <div class="flex flex-col items-center gap-8 w-full h-screen overflow-auto py-8">
        ...
        <div id="print-card-attendance-operational" class="w-max">
            <div class="grid gap-5 grid-cols-1">
                @foreach ($datas as $data)
                    @foreach ($data['attendance_reports'] as $item)
                        <div class="flex flex-col gap-2.5 border rounded p-4 w-full">
                            ...
                            <table class='table border-collapse w-full border '>
                                <thead class=''>
                                    <tr class='border border-2 '>
                                        ...
                                        <th class='text-left border '>
                                            <p class="text-xs font-medium text-gray-500 text-center truncate px-1.5">Status
                                                Operasional
                                            </p>
                                        </th>
                                        <th class='text-left border '>
                                        ...
                                        <th class='text-left border '>
                                            <p class="text-xs px-1.5 font-medium text-gray-500 text-center truncate">Gaji
                                            </p>
                                        </th>
                                        <th class='text-left border '>
                                            <p class="text-xs px-1.5 font-medium text-gray-500 text-center truncate">Lembur
                                            </p>
                                        </th>
                                        <th class='text-left border '>
                                            <p class="text-xs px-1.5 font-medium text-gray-500 text-center truncate">
                                                Tbhn+U.Libur</p>
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach ($item['attendances'] as $key => $attendance)
                                        <tr class='hover:bg-gray-50 border '>
                                            ...
                                            <td class='text-xs border text-center text-gray-500'>
                                            ...
                                            <td class='text-[10px] border text-gray-500 text-center'>
                                                <div class="flex justify-end">
                                                    <div class="w-max px-1.5">
                                                        @if ($attendance['HK_pay_value'])
                                                            @convertnorp($attendance['HK_pay_value'])
                                                        @else
                                                            -
                                                        @endif
                                                    </div>
                                            ...
                                            <td class='text-[10px] border text-gray-500 text-center'>
                                                <div class="flex justify-end">
                                                    <div class="w-max px-1.5">
                                                        @if ($attendance['JL_pay_value'])
                                                            @convertnorp($attendance['JL_pay_value'])
                                                        @else
                                                            -
                                                        @endif
                                                    </div>
                                            ...
                                            <td class='text-[10px] border text-gray-500 text-center'>
                                                <div class="flex justify-end">
                                                    <div class="w-max px-1.5">
                                                        @if ($attendance['tbhn_u_libur_pay_value'])
                                                            @convertnorp($attendance['tbhn_u_libur_pay_value'])
                                                        @else
                                                            -
                                                        @endif
                                                    </div>
                                    ...
                                    <tr class='hover:bg-gray-50'>
                                        ...
                                        <td class="border">
                                            <p class="text-gray-500 flex-1 text-right px-1.5 text-[10px]">
                                                @convertnorp($item['salary_pay_value'] ?? 0)
                                            </p>
                                        </td>
                                        <td class="border">
                                            <p class="text-gray-500 flex-1 text-right px-1.5 text-[10px]">
                                                @convertnorp($item['overtime_pay_value'] ?? 0)
                                            </p>
                                        </td>
                                        <td class="border">
                                            <p class="text-gray-500 flex-1 text-right px-1.5 text-[10px]">
                                                @convertnorp($item['tbhn_u_libur_pay_value'] ?? 0)
                                            </p>
                                        </td>
                                    </tr>
                                </tbody>
                            ...
                            <table class='table border-collapse w-full border '>
                                <thead class=''>
                                    <tr class='border border-2 '>
                                        <th class='text-left border '>
                                            <p class="text-xs font-medium text-gray-500 text-center truncate">Sisa kasbon
                                            </p>
                                        </th>
                                        <th class='text-left border '>
                                            <p class="text-xs font-medium text-gray-500 text-center truncate">Cicilan
                                                kasbon</p>
                                        </th>
                                        <th class='text-left border '>
                                            <p class="text-xs font-medium text-gray-500 text-center truncate">Upah jabatan
                                            </p>
                                        </th>
                                        <th class='text-left border '>
                                            <p class="text-xs font-medium text-gray-500 text-center truncate">Sisa gaji</p>
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <td class='text-[10px] border text-gray-500 text-center'>
                                        <div class="flex justify-end">
                                            <div class="w-max px-1.5">
                                                @if ($item['remaining_kasbon_pay_value'])
                                    ...
                                    <td class='text-[10px] border text-gray-500 text-center'>
                                        <div class="flex justify-end">
                                            <div class="w-max px-1.5">
                                                @if ($item['tbhn_u_position_pay_value'])
    ...
    <script>
        function print(params) {
            ...
            return printContents = document.getElementById(
                    "print-card-attendance-operational").innerHTML,
