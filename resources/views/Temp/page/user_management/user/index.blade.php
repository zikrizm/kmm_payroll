            ...
            <div className='px-6 py-5 w-full'>
                <div
                    ...
                    <span class="text-gray-500 ml-2 ">
                        <x-icon icon="search" width=16 height=16 viewBox="20 20" strokeWidth=0 />
                    </span>
                    <input
                ...
                <tr class="border-b border-grey/200 cursor-pointer hover:bg-grey/50">
                    <td class="px-6 py-4 text-left">
                        <div class="flex gap-3 items-center">
                            ...
                            <div>
                                <p class="text-gray-900 text-sm font-medium truncate sm/max:w-12 xs/max:w-8">Zikri
                                    Marifatullah</p>
                                <p class="text-gray-500 text-sm font-normal truncate sm/max:w-12 xs/max:w-8">
                                    zikrizm@gmail.com</p>
                            </div>
                        </div>
                    ...
                    <td class="px-4 py-4">
                        <div class="flex gap-1">
                            <button class="p-2.5 cursor-pointer text-gray-500 rounded hover:bg-gray-50 delete-btn">
                                <x-icon icon="trash-2" width=16 height=16 viewBox="20 20" strokeWidth=0 />
                            </button>
                            <button class="p-2.5 cursor-pointer text-gray-500 rounded hover:bg-gray-50">
                                <x-icon icon="edit-2" width=16 height=16 viewBox="20 20" strokeWidth=0 />
                            </button>
                        </div>
                    </td>
                </tr>
