        ...
        <tbody class="text-sm font-normal text-gray-700">
            ...
            <tr class="cursor-pointer bg-white hover:bg-gray-50">
                ...
                <td class="px-6 py-3 text-left bg-transparent">
                    <p class="text-gray-500 text-sm font-normal truncate xs/max:w-12">{{ $item->shift_id->name }}</p>
                </td>
                <td class="px-6 py-3 text-left bg-transparent">
                    <p class="text-gray-500 text-sm font-normal truncate xs/max:w-12">per {{ $item->time_period }} menit (Rp) @convert($item->pay)
                    </p>
                </td>
                <td class="px-6 py-3 text-left bg-transparent">
                    {!! $item->statusBox !!}
