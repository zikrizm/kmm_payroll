            ...
            <form class="" method="POST" action="{{ route('login') }}">
                ...
                <div class="px-4 flex flex-col gap-2">
                    ...
                    <div class="flex-1 flex flex-col gap-1">
                        ...
                        <input class="h-10 py-1 px-2 text-sm rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-300 
                            focus:border-transparent" type="password" name="password" placeholder="Password Anda"
                    ...
                    <div class="flex items-center gap-2 mt-2.5">
                        <input class="mt-0.5" type="checkbox" name="remember" id="remember" {{ old('remember') ? 'checked'
                            : '' }}>
