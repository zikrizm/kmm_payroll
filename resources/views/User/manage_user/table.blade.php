<main class='border border-gray-200 rounded-lg shadow-sm w-max overflow-hidden'>
    ...
    <footer class='flex justify-between items-center px-6 pt-3 pb-4'>
        ...
        <div class='flex gap-3'>
            ...
            <button data-pagination-url="{{ $users->previousPageUrl() }}" class='pagination-button px-3.5 py-2 border border-gray-300 rounded-lg text-sm hover:bg-gray-50'>Previous</button>
            @endif
            @if ($users->hasMorePages() )
            <button data-pagination-url="{{ $users->nextPageUrl() }}"  class='pagination-button px-3.5 py-2 border border-gray-300 rounded-lg text-sm hover:bg-gray-50'>Next</button>
            @endif
        </div>
    </footer>
</main>