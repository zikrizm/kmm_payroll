...
@section('content')
    <div class="flex flex-col gap-6 flex-1 h-full overflow-auto bg-white px-8 pt-8 pb-12">
        <header class="flex justify-between items-start">
            <div class="flex flex-col gap-1">
                <p class="text-3xl font-medium text-gray-900">Manage role</p>
                <p class="text-base font-normal text-gray-500">Here to manage the status of each role.</p>
            </div>
            <div class="">
        ...
        <hr>
        <x-ui.search-data placeholder="Search for role" url="{{ route('role.index') }}" />
        <div class="table-content"></div>
        <x-ui.confirm-modal class="submit-delete-role"></x-ui.confirm-modal>
    </div>
    ...
    let dataParams = {};
        ...
        async function onInit(data) {
            ...
            // * get table ----->
            // *
            var res = await ApiService.get_table('/role', data);
        ...
        async function get_modal(user_id) {
            ...
            // * open modal form ----->
            // *
            var URL = (user_id) ? '/role/' + user_id + '/edit' : '/role/create';
            ...
            // * submit form ----->
            // *
            var resSubmit = ApiService.submit_form('.submit-role', (data) => { 
                onInit( { q: $('.search-data-input').val() });
            });
        }
        ...
        // * open modal confirm ----->
        // *
        await ApiService.get_confirm('.submit-delete-role', '/role/' + user_id, null, () => {
            onInit();
        })
    }
</script>
