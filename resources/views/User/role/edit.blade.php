<form autocomplete="off" action="{{ route('role.update', ['role' => $role->id]) }}" method="POST" class="submit-role">
    @csrf
    <!-- {{ csrf_field() }} -->
    <section
        ...
        <div>
            <main class="px-4 flex flex-col gap-4 xs/max:gap-3 mb-8">
                <section class="flex flex-col gap-1">
                    ...
                    {!! FormCustom::input('name', $role->name, [ "placeholder" => 'Enter new your role name'])
                    !!}
                </section>
