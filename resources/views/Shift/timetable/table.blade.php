        ...
        <thead class='border-b border-gray-200 bg-gray-50'>
            <tr class=''>
                ...
                <th class='px-3 py-3 text-left cursor-pointer'>
                    <p class="text-xs font-medium text-gray-500 truncate cursor-pointer">Type</p>
                </th>
                <th class='px-3 py-3 text-left cursor-pointer'>
                ...
                <th class='px-3 py-3 text-left cursor-pointer'>
                    <x-ui.sort-table text="Work time" url="{{ route('timetable.index') }}" field="work_time_duration"
                        order="{{ $order }}" />
                </th>
                <th class='px-3 py-3 text-left cursor-pointer'>
                ...
                <th class='px-3 py-3 text-left cursor-pointer'>
                    <p class="text-xs font-medium text-gray-500 truncate cursor-pointer">Workday</p>
                </th>
                <th class='px-3 py-3 text-left cursor-pointer'>
                    <p class="text-xs font-medium text-gray-500 truncate cursor-pointer">Work type</p>
                </th>
                <th class='px-3 py-3 text-left cursor-pointer'>
                    <p class="text-xs font-medium text-gray-500 truncate cursor-pointer">Overtime</p>
                </th>
                <th class='px-3 py-3 text-left cursor-pointer'>
                    <p class="text-xs font-medium text-gray-500 truncate cursor-pointer">Color settings</p>
                </th>
