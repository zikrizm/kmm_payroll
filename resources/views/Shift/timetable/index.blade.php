...
<script type="application/javascript">
    let dataParams = {};
        ...
        async function onInit(data) {
            ...
            // * get table ----->
            // *
            var res = await ApiService.get_table('/timetable', data);
        ...
        async function get_modal(break_time_id) {
            ...
            var URL = (break_time_id) ? '/timetable/' + break_time_id + '/edit' : '/timetable/create';
        ...
        // * open modal confirm ----->
        // *
        await ApiService.get_confirm('.submit-delete-timetable', '/timetable/' + break_time_id, null, () => {
            onInit();
        })
    }
</script>
