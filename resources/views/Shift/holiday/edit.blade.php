<form autocomplete="off" action="{{ route('holiday.update', ['holiday' => $holiday->id]) }}" method="POST"
        ...
        <header class="px-4 flex flex-col gap-5 pt-4 xs/max:gap-3 relative">
            ...
            <div class="flex flex-col gap-1">
                <div class="flex items-start gap-2">
                    ...
                    <div>
                        <p class="text-2xl font-bold text-gray-900 xs/max:text-xl xs/max:font-semibold">Libur
                        </p>
        ...
        <div>
            <main class="px-4 flex flex-col gap-4 xs/max:gap-3 mb-8">
                <section class="flex flex-col gap-1">
                    ...
                    {!! FormCustom::input('name', $holiday->name, [ "placeholder" => 'Masukkan nama libur']) !!}
                </section>
                <div class="flex flex-col gap-1">
            ...
            <footer class="flex justify-end items-center gap-3 p-4 pb-6 relative">
                <p class="absolute bottom-0.5 left-2 text-gray-400 italic text-[10px]">
                    {{ 'Diperbarui: ' . $holiday->user->first_name . ', ' . $holiday->updated_at }}
                </p>
                <button type="reset"
