        ...
        <header class="px-4 flex flex-col gap-5 pt-4 xs/max:gap-3 relative">
            ...
            <div class="flex flex-col gap-1">
                <div class="flex items-start gap-2">
                    ...
                    <div>
                        <p class="text-2xl font-bold text-gray-900 xs/max:text-xl xs/max:font-semibold">New break-time
                        </p>
            ...
            <main class="px-4 flex flex-col gap-4 xs/max:gap-3 mb-8">
                ...
                <div class="flex items-center gap-3">
                    <section class="flex flex-col gap-1 flex-1">
                        ...
                        {!! FormCustom::input('duration', null, [ "placeholder" => 'Enter new your duration','type' =>
                        'number'])
                        !!}
                    </section>
