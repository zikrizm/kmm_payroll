...
<body class="overflow-hidden">
    ...
    <div id="switch-size-menu"
        ...
        <x-icon icon="chevron-left" class="chevron-left-switch-size-menu duration-500 {{ $is_mini ? 'rotate-180' : '' }}" width=16 height=16
            viewBox="20 20" />
    </div>
                ...
                <aside id="aside-navigation"
                    ...
                    <div class="flex-1">
                        <header class="h-32 w-full flex items-center justify-center flex-col gap-1">
                            ...
                            <p
                                class="text-gray-700 font-medium name-business {{ $is_mini ? 'hidden' : '' }}">
                                {{ Auth::user()->business->name }}</p>
                        </header>
                        <main class="flex flex-col gap-2">
                            <a href="{{ route('home.index') }}" data-tooltip-menu="Dashboard"
                                class="my-dropdown-menu flex items-center {{ $is_mini ? 'justify-center' : 'justify-between' }} hover:bg-gray-50 p-2.5 rounded-lg w-full 
                                @activemenu('home')
bg-gray-100 active
@else
hover:bg-gray-50
@endactivemenu">
                            ...
                            @canany(['department.view', 'position.view', 'area.view', 'device.view'])
                                <section
                                    class="my-dropdown-menu hover:bg-gray-50 flex items-center {{ $is_mini ? 'justify-center' : 'justify-between' }} p-2.5 rounded-lg w-full
...
@endactivemenu">
                                        <div class="flex items-center gap-2.5">
                                            ...
                                            <p
                                                class="text-sub-menu text-sm font-medium text-gray-600">
                                                Perusahaan</p>
                                        </div>
                                    </a>
                                    @can('department.view')
...
@endactivemenu">
                            ...
                            @canany(['user.view', 'role.view'])
                                <section
                                    class="my-dropdown-menu flex items-center {{ $is_mini ? 'justify-center' : 'justify-between' }} p-2.5 rounded-lg w-full 
                                        @activemenu('users')
bg-gray-100 active
@else
hover:bg-gray-50
