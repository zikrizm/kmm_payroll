...
<head>
    ...
    <!-- Scripts -->
    @vite(['resources/js/app.js', 'resources/plugins/Select2/css/select2.css', 'resources/plugins/Select2/js/select2.full.min.js', 'resources/plugins/Toastr/toastr.css', 'resources/plugins/Dropzone/dropzone.css', 'resources/plugins/Dropzone/dropzone.js', 'resources/css/app.css', 'resources/css/custom.css'])
...
<body class="overflow-hidden">
    ...
    <div class="w-full h-screen flex overflow-auto">
        @if (request()->segment(1) != 'print' &&
                ...
                request()->segment(1) != 'employee-photo')
            @if (Auth::user())
                @php
                ...
                <div id="switch-size-menu"
                    ...
                    <x-icon icon="chevron-left"
                        class="chevron-left-switch-size-menu duration-500 {{ $is_mini ? 'rotate-180' : '' }}" width=16
                        height=16 viewBox="20 20" />
                </div>
                <aside id="aside-navigation"
                    ...
                    <div class="flex-1">
                        <header class="h-32 w-full flex items-center justify-center flex-col gap-1">
                            <div
                                class="flex items-center justify-center text-gray-700 w-10 h-10 rounded-full overflow-hidden">
                                @if (!empty(Auth::user()->business->logo))
                                    <img src="{{ Auth::user()->business->logo }}" alt=""
                        ...
                        <main class="flex flex-col gap-2">
                            <a href="{{ route('home.index') }}" data-tooltip-menu="Dashboard"
                                class="my-dropdown-menu cursor-pointer flex items-center {{ $is_mini ? 'justify-center' : 'justify-between' }} hover:bg-gray-50 p-2.5 rounded-lg w-full 
                                @activemenu('home')
bg-gray-100 active
@else
hover:bg-gray-50
@endactivemenu">
                                <div class="flex items-center gap-2.5">
                                    ...
                                    <p
                                        class="text-sm font-medium text-gray-600 name-menu {{ $is_mini ? 'hidden' : '' }}">
                                        Dashboard</p>
                                </div>
                            </a>
                            @canany(['department.view', 'position.view', 'area.view', 'device.view'])
                                <section
                                    class="my-dropdown-menu cursor-pointer hover:bg-gray-50 flex items-center {{ $is_mini ? 'justify-center' : 'justify-between' }} p-2.5 rounded-lg w-full
...
@endactivemenu"
                                    ...
                                    data-tooltip-menu="Pengaturan Perusahaan">
                                    <div class="flex items-center gap-2.5">
                                        <span class="text-gray-600">
                                    ...
                                    <span
                                        class="text-gray-500 chevron-icon-menu  {{ $is_mini ? 'hidden' : '' }} duration-300">
                                        <x-icon icon="chevron-down" width=18 height=18 viewBox="20 20" />
                                    </span>
                                </section>
                                <div id="dropdown-menu-organization"
                                    class="sub-menu-content {{ $is_mini ? 'hidden' : 'flex' }} flex-col gap-1
                                 @activemenu('organization')
sub-menu-active
@else
hidden
...
@endactivemenu">
                            ...
                            @canany(['user.view', 'role.view'])
                                <section
                                    class="my-dropdown-menu cursor-pointer flex items-center {{ $is_mini ? 'justify-center' : 'justify-between' }} p-2.5 rounded-lg w-full 
                                        @activemenu('users')
bg-gray-100 active
@else
hover:bg-gray-50
@endactivemenu"
                                    data-dropdown-toggle="dropdown-menu-user" data-tooltip-menu="Pengaturan Pengguna">
                                    <div class="flex items-center gap-2.5">
                                        <span class="text-gray-600">
                                            <x-icon icon="User" width=18 height=18 viewBox="20 20" />
                                        </span>
                                        <p
                                            class=" {{ $is_mini ? 'hidden' : '' }} name-menu text-sm font-medium text-gray-600">
...
hover:bg-gray-50
@endactivemenu"
                                    data-dropdown-toggle="dropdown-menu-shift" data-tooltip-menu="Pengaturan Waktu">
                                    <div class="flex items-center gap-2.5">
                                        <span class="text-gray-600">
...
hover:bg-gray-50
@endactivemenu"
                                    data-dropdown-toggle="dropdown-menu-employee" data-tooltip-menu="Pengaturan Karyawan">
                                    <div class="flex items-center gap-2.5">
                                        <span class="text-gray-600">
...
@endactivemenu"
                                    ...
                                    data-tooltip-menu="Pengaturan Tugas">
                                    <div class="flex items-center gap-2.5">
                                        <span class="text-gray-600">
                                ...
                                <div id="dropdown-menu-task-management"
                                    class="sub-menu-content {{ $is_mini ? 'hidden' : 'flex' }} flex-col gap-1
                                 @activemenu('task-management')
sub-menu-active
@else
...
hover:bg-gray-50
@endactivemenu"
                                    data-dropdown-toggle="dropdown-menu-reports" data-tooltip-menu="Laporan">
                                    <div class="flex items-center gap-2.5">
                                        <span class="text-gray-600">
...
@endactivemenu">
                                    ...
                                    @can('report.break-time.view')
                                        <a href="{{ route('break-time-report.index') }}"
                                            class="flex items-center justify-between p-2.5 rounded-lg w-full hover:underline hover:decoration-gray-500 
...
@endactivemenu">
                                    ...
                                    @can('attendance-operational.view')
                                        <a href="{{ route('attendance-operational.index') }}"
                                            class="flex items-center justify-between p-2.5 rounded-lg w-full hover:underline hover:decoration-gray-500 
...
@endactivemenu">
                                    ...
                                    @endcan
                                    <a href="{{ route('monitoring-higiene.index') }}"
                                        class="flex items-center justify-between p-2.5 rounded-lg w-full hover:underline hover:decoration-gray-500
                                            @activemenu('monitoring-higiene')
bg-gray-100 active
@else
hover:bg-gray-50
@endactivemenu">
                                        <div class="flex items-center gap-2.5">
                                            <div class="space-sub-menu w-5"></div>
                                            <p class="text-sub-menu text-sm font-medium text-gray-600">
                                                Monitoring Higiene</p>
                                        </div>
                                    </a>
                                    @can('food-archive.view')
                                        <a href="{{ route('food-archive.index') }}"
                                            class="flex items-center justify-between p-2.5 rounded-lg w-full hover:underline hover:decoration-gray-500
            ...
            $(this).on('click', function(e) {
                ...
                if(id_content_dropdown) {
                    if($('#dropdown-menu').hasClass('active-dropdown')) {
                        ...
                        // let position_height = $('#dropdown-menu').outerHeight();
                        ...
                        //     position: "absolute",
                        //     display: 'block',
                        //     top: position_element.top+$(this).outerHeight() - 20, left: position_element.left + 50,
                        // });

                        let dropdown_height = $('#dropdown-menu').outerHeight();
                        let window_height = $(window).height();
                        let trigger_bottom = position_element.top + $(this).outerHeight();
                        let space_below = window_height - trigger_bottom;

                        let top_position;

                        if (dropdown_height > space_below) {
                            // dropdown terlalu tinggi, tampilkan ke atas (sebisa mungkin)
                            top_position = position_element.top - dropdown_height + 20;
                            if (top_position < 0) {
                                top_position = 10; // beri batas atas minimum
                            }
                        } else {
                            // cukup ruang di bawah, tampilkan biasa
                            top_position = trigger_bottom - 20;
                        }

                        // Atur posisi dropdown akhir
                        $('#dropdown-menu').css({
                            position: "absolute",
                            display: 'block',
                            top: top_position,
                            left: position_element.left + 50,
                        });
                    }
                }
