                    ...
                    <div class="flex-1">
                        ...
                        <main class="flex flex-col gap-2">
                            <a href="{{ route('home.index') }}"
                                class="flex items-center justify-between p-2.5 rounded-lg w-full 
                                @activemenu('home')
bg-gray-100 active
@else
hover:bg-gray-50
...
@endactivemenu"
                                ...
                                <div id="dropdown-menu-user"
                                    class="flex flex-col gap-1 @activemenu('users')
@else
hidden
@endactivemenu">
                                    @can('user.view')
...
@endactivemenu"
                                ...
                                <div id="dropdown-menu-attendance"
                                    class="flex flex-col gap-1 
                                    @activemenu('attendances')
@else
hidden
